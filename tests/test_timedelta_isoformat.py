...
invalid_durations = [
    ...
    ("P0000-367", "days value of 367.0 exceeds range [0..366]"),
    ("P0000-400", "days value of 400.0 exceeds range [0..366]"),
    ("P0000-13-00", "months value of 13.0 exceeds range [0..12]"),
    ("PT12:60:00", "minutes value of 60.0 exceeds range [0..60)"),
    ("PT12:61:00", "minutes value of 61.0 exceeds range [0..60)"),
    ("PT15:25:60", "seconds value of 60.0 exceeds range [0..60)"),
    ("PT24:00:00", "hours value of 24.0 exceeds range [0..24)"),
